 ...
 *
 *      Date:            06-23-05
 *      K.H.Kim and S.A.Allison - Renamed to doubSubRecord.c and added
 *                                fields M to Z.
 */

...
epicsExportAddress(rset,doubSubRSET);
...
static long get_units(paddr,units)
    ...
    char	  *units;
{
    struct doubSubRecord	*psub=(struct doubSubRecord *)paddr->precord;
...
struct doubSubRecord *psub;  /* pointer to subroutine record  */
{
	long	status;
	SUBFUNCPTR	psubroutine;
